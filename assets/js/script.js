...
var taskFormHandler = function(event){
    ...
    if(!taskNameInput || !taskTypeInput){
        alert("Please fill out the entire the task form!");
        return false;
    }

    //reset the form input fields using browser-provided DOM element interface reset method for the form element
    formEl.reset();
